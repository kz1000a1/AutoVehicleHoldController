...
SOURCES = main.c system.c usbd_conf.c usbd_cdc_if.c usb_device.c usbd_desc.c interrupts.c system_stm32f0xx.c can.c eliminator.c led.c error.c printf.c
...
TARGET = AutoVehicleHoldController-$(GIT_VERSION)
